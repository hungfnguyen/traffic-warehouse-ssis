...
CREATE TABLE warehouse.DimDate (
   [DateKey]  bigint IDENTITY  NOT NULL
...
SET IDENTITY_INSERT warehouse.DimDate ON;

INSERT INTO warehouse.DimDate
(DateKey, [Date], [Hour], [DayOfWeek], DayOfWeekNumber, [Day], [Month], RowIsCurrent, RowStartDate, RowEndDate, RowChangeReason, InsertAuditKey, UpdateAuditKey)
VALUES
(-1, GETDATE(), 0, 'Unknown', 1, 1, 1, 'Y', '1899-12-31', '9999-12-31', 'N/A', -1, -1);

SET IDENTITY_INSERT warehouse.DimDate OFF;
;
